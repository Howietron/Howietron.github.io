...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyrightInfo:
        'Howietron | <a href="https://github.com/Howietron/Howietron.github.io/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'Howietion', // GitHub仓库所有者
          admin: ['Howietion'], // 对仓库有写权限的人
